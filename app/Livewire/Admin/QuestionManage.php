...
class QuestionManage extends Component
{
    ...
    protected $rules = [
        ...
        'formData.question_text' => 'required|min:10',
    ...
    {
        $this->packages = Package::orderBy('year')->get()->toArray();
    ...
    public function saveQuestion()
    {
        ...
        // Update correct_option_id for TWK/TIU
        if ($correctOptionId && !$isTKP) {
    ...
    public function getQuestionCountsProperty()
    {
        ...
        return Category::withCount(['questions' => function($q) {
