        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-6 bg-gray-50">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="font-medium">
                            @if($type === 'bundle')
                                <span class="line-through text-gray-400 text-sm mr-2">Rp {{ number_format($item->original_price, 0, ',', '.') }}</span>
                ...
                <div class="p-6">
                    <button 
                        id="pay-button"
                        class="w-full py-4 bg-blue-600 text-white rounded-xl font-semibold text-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                    >
            ...
            <div class="mt-8 bg-white rounded-xl shadow-sm p-6">
                <h3 class="font-semibold text-gray-900 mb-4">Metode Pembayaran yang Tersedia</h3>
